...
//	Properties
	...
	public static String PROPRETY_CONTAINS = "contains";
	...
	public static String PROPRETY_ADDRESS = "address";
	public static String PROPRETY_LOCATION = "location";
	public static String PROPRETY_CATEGORY = "category";
	public static String PROPRETY_CITY = "city";
